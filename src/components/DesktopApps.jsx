...
const DesktopApps = ({ onContactsClick, onMusicClick }) => {
    ...
    return (
        <section className="absolute top-8 left-0 flex flex-col items-start justify-evenly text-white mb-10 ml-8">
            <div id='projects' className="dapp flex flex-col mb-2 hover:transform hover:-translate-y-1 hover:cursor-pointer hover:bg-[#cdb6a0] transition-colors transition-padding duration-500 hover:py-2 rounded">
            ...
            <div id='services' className="dapp flex flex-col mb-2 hover:transform hover:-translate-y-1 hover:cursor-pointer hover:bg-[#cdb6a0] transition-colors transition-padding duration-500 hover:py-2 rounded">
            ...
            <div id='contacts' className="dapp flex flex-col mb-2 hover:transform hover:-translate-y-1 hover:cursor-pointer hover:bg-[#cdb6a0] transition-colors transition-padding duration-500 hover:py-2 rounded" onClick={handleContactsClick}>
            ...
            <div id ='music' className="dapp flex flex-col mb-2 hover:transform hover:-translate-y-1 hover:cursor-pointer hover:bg-[#cdb6a0] transition-colors transition-padding duration-500 hover:py-2 rounded" onClick={handleMusicClick}>
